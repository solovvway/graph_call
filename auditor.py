...
# KNOWN_SINKS dictionary populated with functions and methods that are often
# associated with security vulnerabilities (sinks). This list is derived from
# the provided regular expressions for each language.
