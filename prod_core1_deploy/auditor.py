...
def load_core_module(core_name: str):
    ...
    try:
        if core_name == "core1":
            ...
            try:
                from dev_core1.ast_core import CodeParser, EXT_TO_LANG, Node
                from dev_core1.graph_builder import SecurityGraph
                from dev_core1.sinks import KNOWN_SINKS
                from dev_core1.sources import is_php_source
                from dev_core1.trace_processor import TraceProcessor
            except ImportError:
                ...
                from dev_core2.ast_core import CodeParser, EXT_TO_LANG, Node
                from dev_core2.graph_builder import SecurityGraph
                from dev_core2.sinks import KNOWN_SINKS
                from dev_core2.sources import is_php_source
                from dev_core2.trace_processor import TraceProcessor
